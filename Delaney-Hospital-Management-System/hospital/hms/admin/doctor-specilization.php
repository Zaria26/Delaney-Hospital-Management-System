...
$sql=mysqli_query($con,"insert into doctorSpecialization(specialization) values('$doctorspecialization')");
...
{
$sid=$_GET['id'];	
mysqli_query($con,"delete from doctorSpecialization where id = '$sid'");
