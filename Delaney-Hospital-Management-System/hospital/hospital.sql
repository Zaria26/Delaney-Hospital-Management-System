...
(1, 'aboutus', 'About Us', '<ul style=\"padding: 0px; margin-right: 0px; margin-bottom: 1.313em; margin-left: 1.655em;\" times=\"\" new=\"\" roman\";=\"\" font-size:=\"\" 14px;=\"\" text-align:=\"\" center;=\"\" background-color:=\"\" rgb(255,=\"\" 246,=\"\" 246);\"=\"\"><li style=\"text-align: left;\"><font color=\"#000000\"></font></li><li style=\"text-align: left;\"><font color=\"#000000\">Welcome to Delaney Hospital, your trusted healthcare provider. At Delaney Hospital, we are dedicated to delivering exceptional medical care and services to our patients and the community we serve. With a legacy of excellence and a commitment to compassionate care, we strive to be the leading healthcare institution in our region. We are proud to serve our community and remain committed to delivering exceptional healthcare services with compassion, integrity, and excellence. Thank you for choosing Delaney Hospital as your trusted healthcare partner. The Delaney Hospital Management System (DHMS) is designed to replace the existing manual, paper-based system. The new system is to control the following information: patient information, room availability, staff and operating room schedules, and patient invoices. These services are to be provided in an efficient, cost-effective manner, with the goal of reducing the time and resources currently required for such tasks.&nbsp;</font></li></ul>', NULL, NULL, '2020-05-20 07:21:52', NULL),
(2, 'contactus', 'Contact Details', 'D-204, Hole Town South West, Trinidad and Tobago', 'info@gmail.com', 1122334455, '2022-05-20 07:24:07', '9 am To 8 Pm');
